...
{
    internal class Finding : iSubProgram
    {
        ...
        public static Finding ReadProgram()
        {
            return (Finding)new Finding().Initialize();
        }
        ...
        public void Start(int Mode)
        {
            ...
            // Regex: Uppercase character followed by non Whitespace character
